...
def complete_task(
    ...
    # Check achievements for each developer assigned to the task
    for developer in task.assigned_developers:
        achievements.check_and_award(db, developer.id)

    return {"message": "Task has been completed successfully"}